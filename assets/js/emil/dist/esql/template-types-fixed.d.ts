...
export type QueryResultData = HealthCheckResult[] | BaselineComparisonResult[] | TrendAnalysisResult[] | PerformanceMetricsResult[] | Record<string, unknown>[] | null;
...
//# sourceMappingURL=template-types-fixed.d.ts.map