...
export class QueryResultsViewer {
  private options: ResultsViewerOptions;
   ...
   */
  displayResults(result: QueryResult, title: string = 'Query Results'): void {
   ...
   */
  private renderTimeSeries(data: any[]): string {
   ...
   */
  private renderMetadata(result: QueryResult): string {
    const parts = [];
   ...
   * Attach event listeners
   */
  private attachEventListeners(result: QueryResult): void {
   ...
   */
  private exportCSV(result: QueryResult): void {
   ...
   */
  private copyQuery(query: string): void {
