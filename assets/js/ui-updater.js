 ...
 */
export function updateDataTable(results) {
...
export async function updateApiStatus() {
    ...
    if (cookieStatusEl) {
        ...
        cookieStatusEl.style.color = hasCookie ? 'var(--gd-color-success)' : 'var(--gd-color-error)';
    }
    ...
    if (isLocalhost) {
        ...
        if (corsStatusEl) {
            ...
            corsStatusEl.style.color = proxyRunning ? 'var(--gd-color-success)' : 'var(--gd-color-error)';
        }
 ...
 * Hide loading state
 */
export function hideLoading(message = 'Ready') {
    const refreshBtn = document.getElementById('refreshBtn');
    const status = document.getElementById('refreshStatus');
    const loadingIndicator = document.getElementById('loadingIndicator');
 ...
 */
export function updateProxyStatusIndicator(isRunning, errorMessage = null) {
 ...
 */
export function updatePerformanceWidget() {
 ...
 */
export function initializeRadTypeFilters() {
